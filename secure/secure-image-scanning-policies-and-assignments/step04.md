Registry credentials are required for Sysdig Secure to pull and analyze images. To see what registries that have been configured in the system, select `Image Scanning` > `Registry Credentials`.
